...
def add_trend_ta(df, high, low, close, fillna=False):
    ...
    df['trend_aroon_up'] = aroon_up(df, n=25, fillna=fillna)
    df['trend_aroon_down'] = aroon_down(df, n=25, fillna=fillna)
    df['trend_aroon_down'] = df['trend_aroon_up'] = df['trend_aroon_down']
    return df
